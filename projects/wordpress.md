# Déploiement d'un Réseau de Sites Vitrines (WordPress)
...
* Optimisation des balises *Title* et *Meta Description* liées aux requêtes de la logistique.
...
* **Développer la présence en ligne de l'organisation :**
  ...
  * *Référencer les services en ligne :* Travail d'optimisation SEO ciblé sur l'activité logistique.
* **Mettre à disposition des utilisateurs un service informatique :**
  * *Déployer un service :* Mise en production, configuration OVH et installation du CMS WordPress.
* **Gérer le patrimoine informatique :**
  * *Vérifier les conditions de la continuité d’un service :* Gestion de l'hébergement, des noms de domaine et de la sécurité de base des sites (SSL).